...
export function ProductBaseDetails({
    ...
    const reducerType = mode === 'add' ? 'CREATE' : 'EDIT';
    return (
        <div className="flex flex-col gap-6 p-2">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                    ...
                    />
                    {errors.productTitle && <span className="text-xs text-[#ffb4ab] mt-1.5 block">{errors.productTitle}</span>}
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="0.00"
                    />
                    {errors.basePrice && <span className="text-xs text-[#ffb4ab] mt-1.5 block">{errors.basePrice}</span>}
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-2">
                    <label className="text-xs font-semibold uppercase tracking-wider text-[#a6a7a6]">Brand</label>
                    <DashboardSelectBrand
                        reducerType={reducerType}
                        choosenBrand={ProductDetailState.brand}
                        dispatchProductDetailCreate={dispatchProductDetailCreate}
                        ProductDetailEditReducer={dispatchProductDetailCreate as any}
                    />
                ...
                {/* Category Picker */}
                <div className="flex flex-col gap-2">
                    <label className="text-xs font-semibold uppercase tracking-wider text-[#a6a7a6]">Category</label>
                    <DashboardSelectCategory
                        ReducerType={reducerType}
                ...
                {/* SubCategory Picker */}
                <div className="flex flex-col gap-2">
                    <label className="text-xs font-semibold uppercase tracking-wider text-[#a6a7a6]">Sub Category</label>
                    <DashboardSelectSubCategory
                        ReducerType={reducerType}
