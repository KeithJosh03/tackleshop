...
export default function CollectionCard() {
  return (
    ...
    <div className='h-fit basis-1/4 border px-4 py-2 flex flex-col gap-y-2 items-center justify-between border-greyColor transition-all hover:gradientborder'>
        ...
        <div className={`${worksans.className} flex flex-col text-lg w-full justify-center items-center text-center gap-y-1 text-tertiaryColor`}>
            <h3 className='font-extrabold text-xl text-primaryColor'>
            Shimano Rod FX 2500
            </h3>
