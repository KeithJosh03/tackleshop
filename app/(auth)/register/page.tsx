            ...
            <div className="w-full bg-ma-surface/70 backdrop-blur-xl border border-ma-surface-bright rounded-[1rem] p-8 sm:p-10 shadow-2xl flex flex-col items-center relative z-10">
                ...
                <form className="w-full flex flex-col gap-4" onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-ma-primary text-ma-on-primary rounded-[0.5rem] py-3.5 flex items-center justify-center
                        font-[700] text-[16px] tracking-wider uppercase hover:bg-ma-primary-container transition-colors shadow-lg
                        shadow-ma-primary/10 mt-4 disabled:opacity-50 hover:cursor-pointer"
                    >
