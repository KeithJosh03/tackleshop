            ...
            <div className="w-full bg-ma-surface/70 backdrop-blur-xl border border-ma-surface-bright rounded-[1rem] p-8 sm:p-10 shadow-2xl flex flex-col items-center relative z-10">
                ...
                <form className="w-full flex flex-col gap-5" onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-ma-primary text-ma-on-primary rounded-[0.5rem] py-3 flex items-center justify-center gap-3 font-[700] text-[15px] hover:bg-ma-primary/90 transition-colors mt-2 disabled:opacity-70"
                    >
                    ...
                    <button
                        ...
                        className="w-full bg-white text-[#101415] rounded-[0.5rem] py-2.5 flex items-center justify-center gap-3 font-[700] text-[14px] hover:bg-gray-100 transition-colors mt-2"
                    >
                    ...
                    {/* OR Divider */}
                    <div className="flex items-center gap-3 my-1 opacity-80">
                    ...
                    <button
                        ...
                        className="w-full bg-[#1877F2] text-white rounded-[0.5rem] py-2.5 flex items-center justify-center gap-3 font-[700] text-[14px] hover:bg-[#166fe5] transition-colors"
                    >
