...
import { editProductDetailsFetch } from "@/lib/api/productService";
...
export default function EditProductClient({
  ...
  return (
    ...
    //       ProductDetailEditReducer={(action: any) => {
    //         dispatchProductDetailEdit(action);
    //         if (errors.media) setErrors(p => ({ ...p, media: '' }));
    //       }}
    //       ReducerType='EDIT'
    //     />
    //   </SectionCard>
    ...
    //   {/* ── Section 5 · Variants ── */}
    //   {Array.isArray(productDetailState.productVariants) && productDetailState.productVariants.length > 0 && (
    ...
    //             <path fillRule='evenodd' d='M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z' clipRule='evenodd' />
    //           </svg>
    //           <p className='text-xs font-semibold' style={{ color: '#f87171' }}>{errors.variants}</p>
    //         </div>
    //       )}
    //       <DashboardVariantsComponent
    //         ReduceType='EDIT'
    ...
    //         ProductDetailEditReducer={(action: any) => {
    //           dispatchProductDetailEdit(action);
    //           if (errors.variants) setErrors(p => ({ ...p, variants: '' }));
    //         }}
    //       />
    //     </SectionCard>
    //   )}
